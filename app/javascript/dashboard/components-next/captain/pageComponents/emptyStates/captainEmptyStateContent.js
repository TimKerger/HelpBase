...
export const documentsList = [
  {
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688192-how-to-use-conversation-filters',
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | HelpBase',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | HelpBase',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688210-managing-customer-profiles',
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | HelpBase',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688220-sales-tracking-guide',
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | HelpBase',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | HelpBase',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    external_link:
      'https://www.helpbase.app/hc/user-guide/articles/1677688240-financial-reporting',
    id: 3064,
    name: 'Financial Reporting | User Guide | HelpBase',
    status: 'available',
  },
];
