export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    trigger_rules: {
      url: 'https://www.helpbase.app/features/chatbot/',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://www.helpbase.app/pricings',
      time_on_page: 10,
    },
  ...
  },
  {
    ...
    message: 'Hi! HelpBase here. Need help setting up? Let me know!',
    campaign_status: 'active',
    enabled: false,
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://{*.}?helpbase.app/apps/account/*/settings/inboxes/new/',
      time_on_page: 10,
    },
    trigger_only_during_business_hours: false,
