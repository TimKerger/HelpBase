export default {
  ...
  DOCS_URL: 'https://www.helpbase.app/docs/product/',
  HELP_CENTER_DOCS_URL:
    'https://www.helpbase.app/docs/product/others/help-center',
  TESTIMONIAL_URL:
    'https://testimonials.cdn.helpbase.app/testimonial-content.json',
